    ...
    <div className="min-h-screen bg-[#F8FAFC] py-12 px-5">
      <div className="max-w-2xl mx-auto bg-white rounded-3xl border border-gray-100 shadow-sm p-8">
        ...
        <div className="prose prose-sm max-w-none text-gray-700 leading-relaxed flex flex-col gap-4">
          <p>
            Dorm Dash is a UCSD-affiliated student delivery service operated in partnership with
            UCSD Housing-Dining-Hospitality (HDH). This page summarizes what we collect and why.
          </p>
          ...
          <ul className="list-disc pl-5 flex flex-col gap-1.5 text-sm">
            ...
            <li><b>Order details</b> — items, dining hall, total — used to fulfill the delivery and to report aggregated commission to HDH.</li>
          ...
          <ul className="list-disc pl-5 flex flex-col gap-1.5 text-sm">
            ...
            <li><b>UCSD HDH</b> receives <i>aggregated</i> reports — total orders, GMV per hall, peak hours — never individual student records.</li>
            <li><b>UCSD admins</b> may access individual records to resolve disputes or safety incidents only.</li>
          ...
          <p className="text-sm">
            Dashers operate as independent contractors for the duration of the pilot. They are responsible
            for their own transportation, helmet/safety gear, and any third-party insurance. UCSD HDH and
            Dorm Dash do not provide vehicle or medical insurance.
          </p>
        </div>
      </div>
    </div>
